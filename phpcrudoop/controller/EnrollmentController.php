...
require_once __DIR__ . '/../model/Enrollments.php';
...
class EnrollmentController {
    ...
    public function __construct() {
        ...
        $this->enrollment = new Enrollments($this->db);
    }

    public function create($student_id, $course_name, $enrollment_date) {
        $this->enrollment->student_id = $student_id;
        $this->enrollment->course_name = $course_name;
    ...
    public function update($id, $course_name, $enrollment_date) {
        $this->enrollment->id = $id;
        $this->enrollment->course_name = $course_name;
        $this->enrollment->enrollment_date = $enrollment_date;
